            ...
            savedJobData.map((item, index) => (
              <div className="card-job search" key={index}>
                <div className="search-job-top">
                  ...
                  <h6>
                    {item?.job_title}
                    <p style={{ color: "#3B96E1", fontSize: "0.8rem", wordWrap: "break-word" }}>
                      {item?.company_details?.company_name || ""}
                    </p>
                  </h6>
                  {item?.Green_Batch && (
                    <div className="green-thik">
                      <img src={Verified} alt="Verified" height="20px" />
                    </div>
                  )}
                </div>
                  ...
                  >
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <span className="card-table-span">{item?.experience} Years</span>
                        </td>
                      </tr>
                      <tr>
                        <td style={{ paddingRight: "30px" }}>
                        ...
                        <td>
                          <span className="card-table-span">{item?.location}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style={{ paddingRight: "30px" }}>
                        ...
                        <td>
                          <span className="card-table-span">{item?.salary} LPA</span>
                        </td>
                      </tr>
                      <tr>
                        <td style={{ paddingRight: "30px" }}>
                      ...
                      <tr>
                        ...
                        <td>
                          <span className="card-table-span">{formatDate(item?.createdDate)}</span>
                        </td>
                      </tr>
                      <tr>
                        <td style={{ paddingRight: "30px" }}>
