...
const ProfileCompletionModal = ({ onClose }) => {
  ...
  const sections = [
    ...
    { name: "Personal Details", progress: profileCompletion.personalDetails },
    { name: "Work Details", progress: profileCompletion.workDetails },
    { name: "Education Details", progress: profileCompletion.educationDetails },
  ];
    ...
    >
      <Modal.Body>
        <div className="text-center">
          ...
          <ul className="list-unstyled">
            {sections.map((section, index) => (
              <li key={index} style={{ marginBottom: "10px" }}>
                <strong style={{fontSize:'0.8rem'}}>{section.name}:</strong>
                <ProgressBar
          ...
          <Button variant="success" style={{fontSize:'0.8rem'}} onClick={onClose}>
