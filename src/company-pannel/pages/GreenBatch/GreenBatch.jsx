...
const GreenBatch = () => {
    ...
    const handle_promote_job = async () => {
        try {
            const response = await axios.get(`${BaseUrl}company/get/green_batch`);
            ...
            >
                <div className="promote-job">
                    ...
                    <div className="promote-btn-div">
                        <Button size="sm" onClick={() => GreenBatchVerify(Data?._id)}>
                            PAY {'₹' + Data?.price}
                        </Button>
                        <br />
                        <span className="custom-color fw-bold custom-font-size valid-for-text" style={{ fontWeight: 'lighter' }}>
